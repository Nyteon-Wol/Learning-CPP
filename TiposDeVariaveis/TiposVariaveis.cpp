...
int main()
{
	...
	char Caractere = '3';
	char Caractere2 = 'K';
	bool bAchou;/*qualquer coisa diferente de 0 vira true
	ao ser atribuido ao bool */
